...
module ddr (
	...
	ddr_controller_phy	ddr_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="ddr_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr_alt_ddrx_controller_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="ddr_phy_alt_mem_phy_seq.vhd,ddr_phy_alt_mem_phy_seq_wrapper.vhd,ddr_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr_alt_ddrx_controller_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr_alt_mem_phy_seq_wrapper;+ddr_alt_mem_phy_reconfig;+ddr_alt_mem_phy_pll;+ddr_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\work\sell\bitstream_ddr_quartus\src\altera\ddr/ddr_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
