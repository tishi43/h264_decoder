...
module ddr_phy (
	...
	ddr_phy_alt_mem_phy	ddr_phy_alt_mem_phy_inst(
	...
	defparam
		ddr_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		ddr_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		ddr_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ddr_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		ddr_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ddr_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		ddr_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		ddr_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		ddr_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		ddr_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		ddr_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		ddr_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		ddr_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		ddr_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		ddr_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		ddr_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		ddr_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		ddr_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 10000,
		ddr_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "10000 ps",
		ddr_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 50,
		ddr_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		ddr_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ddr_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ddr_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 80,
		ddr_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		ddr_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		ddr_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		ddr_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Micron MT46V16M16TG-5B"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tdha_ps" value="450"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "t_DH" value="0.45"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "t_DH_calculated" value="0.450"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr_phy_alt_mem_phy_seq_wrapper;+ddr_phy_alt_mem_phy_reconfig;+ddr_phy_alt_mem_phy_pll;+ddr_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=D:\work\sell\bitstream_ddr_quartus\src\altera\ddr/ddr_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP4CE40F23I7"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
